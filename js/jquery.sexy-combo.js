...
;(function($) {
	...
	setListHeight: function() {
	    ...
	    var liHeight = this.getListItemsHeight()==0?100:this.getListItemsHeight();
		
	    var maxHeight = this.getListMaxHeight();//==0?80:this.getListMaxHeight();
		
	
	    var listHeight = this.listWrapper.height()==0?200:this.listWrapper.height();
		//alert(liHeight +" "+ maxHeight+" "+listHeight);
	  /* if(listHeight==0)
		{
